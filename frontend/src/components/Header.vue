<template>
    <header id="mainHeader" class="row">
        <h1 class="hidden">Home Page Layout</h1>
        <nav id="mainNav" >
          <h2 class="hidden">Main Navigation</h2>
          <div id="logo">
            <a href="#/"><img src="//0100.ga:3000/api/assets/logo.jpeg" alt="main logo" width="100px" /></a>
          </div>
          <nav role="navigation">
            <div id="menuToggle">
              <input type="checkbox" />
                ...
                <span></span>
              <ul id="menu">
                  <li><a href="#/product/RIP">RIP</a></li>
                  <li><a href="#/product/SKIN">SKIN</a></li>
                  <li><a href="#/product/EYE">EYE</a></li>
              </ul>
            </div>
          </nav>
                <div id="common-menu">
